...
const STR_MENU_ITEM MenuList[] = {
    ...
    {vo_Null, "PF2", "侧键2短按"},
    {vo_Null, "Auto Backlight", "自动背光灯"},
    {vo_Null, "LCD Contrast", "LCD对比度"},
    {vo_Null, "LCD Invert", "屏幕反显"},
    {vo_Null, "Auto Lock", "自动键盘锁"},
