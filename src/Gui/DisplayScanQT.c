...
extern void QTScanDisplay(U8 ctsDcsType, U32 dat, U8 isStandard)
{
    String disBuf[15] = {0};
    memset(disBuf, ' ', 14);
    LCD_DisplayText(49, 28, (U8 *)&disBuf, FONTSIZE_12, LCD_DIS_NORMAL);
...
extern void QTScanDisplayStatus(U8 status)
{
    ...
    LCD_DisplayText(17, 28, (U8 *)&disBuf, FONTSIZE_12, LCD_DIS_NORMAL);
...
extern void QTScanDisplayHome(void)
{
    ...
    LCD_DisplayText(30, 28, (U8 *)&disBuf, FONTSIZE_16, LCD_DIS_NORMAL);
